...
Moon_Exterior_Fog_Change(Ent_Player)
{
	...
	// moon exterior (fog) settings
		...
		// thread clientscripts\_zombiemode::zombie_vision_set_apply( level._moon_exterior_vision_set, level._moon_exterior_vision_set_priority, 1,local_clientnum );
...
moon_interior_fog_change(ent_player)
{
	...
	ent_player endon("entityshutdown");
		...
		// thread clientscripts\_zombiemode::zombie_vision_set_apply( level._moon_interior_vision_set, level._moon_interior_vision_set_priority, 1,local_clientnum );
